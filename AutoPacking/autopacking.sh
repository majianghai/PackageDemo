...
# 【配置上传到蒲公英相关信息】(可选)
__PGYER_API_KEY="0e2813d5f4018f69778d5dbbxxxxxxxx"


# 【配置证书】(如果只有一个证书时该项 可选)
__CODE_SIGN_DISTRIBUTION="iPhone Distribution: Beijing xxxxxxxx Business Co., Ltd."
__CODE_SIGN_DEVELOPMENT="iPhone Developer: yun tu (xxxxxxxx)"
...
# 1. 请选择 SCHEME
__SELECT_TARGET_OPTIONS=("1.PackageDemo")
...
if [[ $__SELECT_TARGET_OPTION -eq 1 ]]; then
  __BUILD_TARGET="PackageDemo"
  __SCHEME_NAME="PackageDemo"
else
...
# 5.上传安装包到指定位置
__UPLOAD_IPA_OPTIONS=("1.None" "2.Pgyer")
